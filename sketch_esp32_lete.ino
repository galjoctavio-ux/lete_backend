...
// == - Contraseña de seguridad para la interfaz web de diagnóstico. bla
// =========================================================================
...
const char* firmware_version_url = "https://raw.githubusercontent.com/galjoctavio-ux/lete_scripts_backend/refs/heads/main/firmware.version";

// Usamos %s como un comodín para el número de versión
const char* firmware_bin_url_template = "https://github.com/galjoctavio-ux/lete_scripts_backend/releases/download/%s/sketch_esp32_lete.ino.bin";
