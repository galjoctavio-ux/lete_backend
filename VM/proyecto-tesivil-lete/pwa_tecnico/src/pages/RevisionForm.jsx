...
import api from '../apiService'; // Importar API
...
function RevisionForm() {
  ...
  const [formData, setFormData] = useState({
    ...
    firmaBase64: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAACklEQVR4nGMAAQAABQABDQottAAAAABJRU5ErkJggg==', // Firma temporal de 1px
  });
  ...
  const handleAddEquipo = () => {
    setFormData(prev => ({
      ...
      equiposData: [
        ...prev.equiposData,
        { id: Date.now(), nombre_equipo: 'Refrigerador', nombre_personalizado: '', amperaje_medido: 1.0, tiempo_uso: 1, unidad_tiempo: 'Horas/Día', estado_equipo: 'Bueno' }
      ]
    }));
  };
...
const val = (type === 'number') ? (parseFloat(value) || 0) : value;
  ...
  const handleSubmit = async () => {
    ...
    const payload = { revisionData, equiposData, firmaBase64 };
            ...
            {tienePaneles && (
              <div style={{background: '#e8f5e9', padding: '10px', marginTop: '15px'}}>
                ...
                <div style={inputGroupStyle}>
                  ...
                  <input type="number" name="paneles_antiguedad_anos" id="paneles_antiguedad_anos" onChange={handleChange} step="1" />
                </div>
              </div>
            )}
          </div>
...
{currentStep === 6 && (
          <div>
            ...
            <div style={inputGroupStyle}>
              ...
              <div style={{border: '1px solid black', height: '150px', background: '#f9f9f9'}}>(Aquí irá el componente Canvas de firma)</div>
            </div>
